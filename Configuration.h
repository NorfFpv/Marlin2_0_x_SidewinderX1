...
#define STRING_CONFIG_H_AUTHOR "(Norf, Sidewinder X1)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.56, 80.68, 399.5, 394 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 28, 0 } // Z -1.7 Norf Sidewinder X1
...
#define XY_PROBE_SPEED 4500   // 75mm/s
...
#define INVERT_E0_DIR false   // Stock X1 Extruder true!! Joni
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (40*60)  // 50mm/s
#define HOMING_FEEDRATE_Z  (12*60)  // 10mm/s
