...
//#define CODEPENDENT_XY_HOMING
  ...
  //#define BLTOUCH_FORCE_SW_MODE   // Found out my V3.1 only works in Switch Mode correct Norf
...
//#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY {{ 275, 150 }, { 25, 150 }}
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 50 } // Feedrates for manual moves along X, Y, Z, E from panel
